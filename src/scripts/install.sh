...
download_cc_cli() {
    ...
    local download_url="https://github.com/codecomet-io/cli/releases/download/v${PARAM_CC_CLI_VERSION}/codecomet-v${PARAM_CC_CLI_VERSION}-${platform}.${file_extension}"
...
if ! download_cc_cli "$platform" "$file_extension"; then
